 ...
 *
 * @param startTimeMillis the start of the interval
 * @param endTimeMilli the end of the interval
 * @param res resources used to load formatted strings
 */
fun convertDurationToFormatted(startTimeMillis: Long, endTimeMilli: Long, res: Resources): String {
    val durationMilli = endTimeMilli - startTimeMillis
    val weekdayString = SimpleDateFormat("EEEE", Locale.getDefault()).format(startTimeMillis)
    return when {
